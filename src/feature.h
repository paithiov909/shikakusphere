...
constexpr int N_CHANNELS_PUBLIC =
    N_CHANNELS_STATUS + N_CHANNELS_SHOUPAI + N_CHANNELS_FULOU * 4 +
    N_CHANNELS_PAI + N_CHANNELS_PAI + N_CHANNELS_TINGPAI +
    N_CHANNELS_LIZHI * 4 + N_CHANNELS_HE * 4 + N_CHANNELS_TAJIADAPAI +
    N_CHANNELS_BAOPAI + N_CHANNELS_MENFENG + N_CHANNELS_ZHUANGFENG +
    N_CHANNELS_PAISHU;

constexpr int N_CHANNELS_SHAN = 4 + 3;

constexpr int N_CHANNELS_PRIVATE = N_CHANNELS_SHOUPAI * 3 +
                                   N_CHANNELS_TINGPAI * 3 + N_CHANNELS_SHAN +
                                   N_CHANNELS_BAOPAI;
