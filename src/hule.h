...
struct Hupai {
  ...
  Hupai(const Name name, const int fanshu, const char baojia)
      : name{name}, fanshu{fanshu}, baojia{baojia} {}
  Hupai(const Name name, const int fanshu)
      : name{name}, fanshu{fanshu}, baojia{} {}
  bool operator==(const Hupai& other) const {
    return name == other.name && fanshu == other.fanshu &&
           baojia == other.baojia;
  }
};
...
struct Defen {
  ...
  bool operator==(const Defen& other) const {
    return hupai == other.hupai && fu == other.fu && fanshu == other.fanshu &&
           damanguan == other.damanguan && defen == other.defen &&
           fenpei == other.fenpei;
  }
};
...
std::vector<std::vector<std::string>> hule_mianzi(
